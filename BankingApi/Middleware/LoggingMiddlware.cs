...
namespace BankingApi.Middleware
{
    public class LoggingMiddleware
    {
        private static readonly HashSet<string> SensitiveFields = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "apikey", "api_key", "key", "__requestverificationtoken"
            // Removed "transactionid" from the sensitive fields list
        };
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            try
            {
                ...
                var responseLog = $"[{DateTime.Now:M/d/yyyy h:mm:ss tt}] Response: {request.Method} {request.Path} | Status: {context.Response.StatusCode} | Body: {sanitizedResponse}";
